...
class BlockChain:
    ...
    def new_data(self, sender, recipient, quantity): 
        # adds a new trasaction to the data of the trasaction
    ...
    def verifying_proof(last_proof, proof):
        # verifying the proof : does hash(last_block, proof) contain 4 leading zeroes?
...
print("***Mining UN Credits about to start***")
...
print("***Mining UN Credits has been successful***")
print(blockchain.chain)
